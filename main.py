...
class CrosswordCreator():
    ...
    def print(self, assignment):
        ...
        """
        print("Variable Name | Starting Cell | Domain")
        print("==============================================")
        # for j, words in self.domains.items():
        #     print(f"{j} + {words}")

        for var, word in assignment.items():
            print(f"{var.num} {var.direction}  |  {var.num}   |  {word}  ")
    ...
    def backtrack_ac3(self, assignment):
        ...
        return pre_assignment_domains


def main():
    # Check usage

    structure = input("Type the file name for the structure file: ")
    words = input("Type the file name for the word file: ")
